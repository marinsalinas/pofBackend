...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <script src="index/js/vendor/modernizr-2.7.1.min.js"></script>
        <style type="text/css">
			.back-link a {
				color: #4ca340;
    ...
    <body class="loading">
        ...
        <![endif]-->
       	<main>
		    ...
		    <section id="slide-2">
		    	<div class="bcg" data-0="background-color:rgb(255, 183,77);" data-top="background-color:rgb(251,140,0);"  data-anchor-target="#slide-2">
			    	<div class="hsContainer">
			    		<div class="hsContent">
...
<section id="slide-3" class="homeSlide">
	<div class="bcg" data-center="background-position: 0px 50%;" data-bottom-top="background-position: 0px 40%;" data-top-bottom="background-position: -40px 50%;" data-anchor-target="#slide-3">
        ...
        <script src="index/js/imagesloaded.js"></script>
        <script src="index/js/skrollr.js"></script>
        <script src="index/js/_main.js"></script>
